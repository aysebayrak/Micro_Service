...
using CasgemMicroservice.Services.Cargo.DataAccessLayer.Repositories;
...
{
    opt.Filters.Add(new AuthorizeFilter(requireAuthorizePolicy)); //kullanýcýyý giriþe zorladýk
});
...
builder.Services.AddScoped<ICargoStateDal, EfCargoStatelDal>();
