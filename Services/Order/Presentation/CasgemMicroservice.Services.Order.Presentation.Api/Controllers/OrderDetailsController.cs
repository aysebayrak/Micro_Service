...
namespace CasgemMicroservice.Services.Order.Presentation.Api.Controllers
{
    ...
    public class OrderDetailsController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<IActionResult> OrderiDetailGetById(int id)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> OrderCreate(CreateOrderDetailCommandRequest createOrderDetailCommandRequest)
        {
            await _mediator.Send(createOrderDetailCommandRequest);
            return Ok("Sipairs Detayı Eklendi");
