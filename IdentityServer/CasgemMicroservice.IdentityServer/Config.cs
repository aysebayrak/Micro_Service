                  ...
                  new ApiScope("catalog_fullpermission","Ürün Listesi İçin tam erişim"),
                    new ApiScope("photostock_fullpermission","Fotograf İşlemleri  için Tam erişim"),
                      ...
                      new ApiScope("discount_fullpermission","indirim  İşlemleri  için Tam erişim"),
                         ...
                         new ApiScope("cargo_fullpermission","Siparis  Detayı İşlemleri  için Tam erişim"),
                            new ApiScope("payment_fullpermission","Siparis  Detayı İşlemleri  için Tam erişim"),
                             new ApiScope("gateway_fullpermission","Ödeme  Api İşlemleri  için Tam erişim"),
